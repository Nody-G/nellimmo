import { Buyer, MandateAuditLog, ContactLead, EstimationLead, TransactionDeal, ProspectingLead, AgencyKey, AgencySignboard, MandateAvenant, ProposalHistory, PartnerAgency, DelegationAgreement } from './types';
