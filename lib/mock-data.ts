import { Property, Buyer, VisitSheet, MandateAuditLog, AgencySettings, DVFTransaction, ContactLead, EstimationLead } from './types';

export const INITIAL_AGENCY_SETTINGS: AgencySettings = {
  agency_name: "Nell'Immo Immobilier",
  agent_name: "Nelly & Niels FERNANDEZ",
