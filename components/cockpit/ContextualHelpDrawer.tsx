            ...
            <div className="w-screen max-w-md sm:max-w-lg bg-white shadow-2xl border-l border-gray-200 flex flex-col animate-slide-drawer">
              ...
              <div className="p-4 bg-gray-50 border-t border-gray-200 flex items-center justify-between">
                <button
                  type="button"
                  onClick={() => setIsOpen(false)}
                  className="w-full py-2.5 px-4 bg-[#E12B7B] hover:bg-[#C71B62] text-white rounded-xl text-xs font-bold text-center flex items-center justify-center gap-2 shadow-xs transition cursor-pointer"
                >
