...
import { DpeLetter } from '@/lib/types';
import { DPE_COLORS, DPE_LETTERS } from './dpe-constants';

interface DpeScaleColumnProps {
  currentLetter?: DpeLetter;
  currentValue?: number;
}

export function DpeScaleColumn({ currentLetter, currentValue }: DpeScaleColumnProps) {
  return (
